...
{}
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "SONG TITLE", "CATEGORY", "ARTIST NAME", "LENGTH", "DESCRIPTION"
            }
        ));
...
model=(DefaultTableModel) jTable1.getModel();
 try{
    ...
    String query="select * from main_table where CATEGORY='"+s+"';";
...
JOptionPane.showMessageDialog(rootPane,model.getValueAt(WIDTH, WIDTH) );
